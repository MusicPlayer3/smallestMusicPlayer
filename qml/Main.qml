...
ApplicationWindow {
    ...
    onIsDockCapableChanged: {
        ...
        if (isDockCapable) isSidebarOpen = true; else isSidebarOpen = false
    ...
    Connections {
        ...
        function onScanCompleted() { musicListModel.loadRoot(); }
        function onSongTitleChanged() { musicListModel.refreshPlayingState() }
    }

    FontLoader { id: materialFont; source: "qrc:/MaterialIcons-Regular.ttf" }
    ...
    Rectangle {
        ...
        gradient: Gradient {
            ...
            GradientStop { position: 1.0; color: playerController.gradientColor3; Behavior on color { ColorAnimation { duration: 500 } } } 
        }
    ...
    FolderDialog {
        ...
        onAccepted: {
            ...
            if (Qt.platform.os === "windows" && folderPath.startsWith("/")) folderPath = folderPath.substring(1);
    ...
    Item {
        ...
        // X 轴位移动画
        Behavior on x { enabled: window.layoutAnimEnabled; NumberAnimation { duration: 300; easing.type: Easing.OutCubic } }
        ...
        ColumnLayout {
            ...
            Item {
                ...
                RectangularGlow {
                    ...
                    glowRadius: 10; spread: 0.1; color: "#80000000"; cornerRadius: 20; z:-1
                }
                Rectangle {
                    id: coverRect
                    anchors.fill: parent
                    ...
                    Image {
                        ...
                        layer.effect: OpacityMask{
                            anchors.fill: parent
                            maskSource: Rectangle { width: bigPNG.width; height: bigPNG.height; radius: 20; color: "white" }
                        }
                    }
                }
            }
            ...
            WaveformProgressBar {
                ...
                progress: playerController.totalDurationMicrosec > 0 ? 
                          (playerController.currentPosMicrosec / playerController.totalDurationMicrosec) : 0
            ...
            RowLayout {
                ...
                Text { text: "volume_down"; color: "#CCC"; font.pixelSize: 20; font.family: materialFont.name}
                ...
                Text { text: "volume_up"; color: "#CCC"; font.pixelSize: 20; font.family: materialFont.name}
            }
            ...
            RowLayout {
                ...
                Row {
                    ...
                    StyleButton {
                        ...
                        checkable: true; checked: playerController.isShuffle
                    }
                }
    ...
    Row {
        ...
        Repeater {
            ...
            delegate: Button {
                ...
                contentItem: Text {
                    text: btn.text; color: "white"; font.pixelSize: 15
                    horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter
                    font.weight: Font.Black; font.family: materialFont.name
                }
                onClicked: {
                   switch(index){
                        case 0: window.showMinimized(); break;
                        case 1: if(isMaxWindow) window.showNormal(); else window.showMaximized(); isMaxWindow = !isMaxWindow; break;
